...
-- || ===============> Stash
exports[Config.Target]:AddBoxZone("StashVU", vector3(128.82, -1284.15, 29.27), 0.5, 1.5, 
    { name="StashVU", heading = 300, debugPoly = false, minZ = 25.27, maxZ = 29.27 }, 
...
exports[Config.Target]:AddBoxZone("Wardrobe", vector3(104.31, -1302.26, 28.79), 2, 0.5, 
    ...
    { options = { {  event = "qb-clothing:client:openOutfitMenu", icon = "fa-solid fa-clipboard-list", label = "Wardrobe" }, },  distance = 2.0 })
...
--exports[Config.Target]:AddBoxZone("Tray04", vector3(0, 0, 0), 0, 0, 
 --   { name="Tray04", heading = 0, debugPoly = false, minZ = 0, maxZ = 0 }, 
  --  { options = { {  event = "zlexif-vu:Client:OpenTray04", icon = "fa-solid fa-clipboard-list", label = "Tray" }, },  distance = 2.0 })