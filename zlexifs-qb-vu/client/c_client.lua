...
RegisterNetEvent('zlexif-vu:Client:Notify')
AddEventHandler("zlexif-vu:Client:Notify", function(msg,type)
    Notify(msg,type)
end)
...
AddEventHandler('zlexif-vu:Client:Sit', function()
...
function CraftDrinks(weapon)
    QBCore.Functions.Progressbar('CraftDrinks', Language.Progressbars.Make..Config.Drinks[weapon].label, 5000, false, false, {
        ...
        TriggerServerEvent('zlexif-vu:server:CraftDrinks', Config.Drinks[weapon].hash)
        for k, v in pairs(Config.Drinks[weapon].materials) do
             TriggerServerEvent('zlexif-vu:Server:RemoveItem', v.item, v.amount)
...
function CraftFood(weapon)
    QBCore.Functions.Progressbar('CraftFood', Language.Progressbars.Make..Config.Food[weapon].label, 6000, false, false, {
        ...
        TriggerServerEvent('zlexif-vu:server:CraftFood', Config.Food[weapon].hash)
...
RegisterNetEvent('zlexif-vu:Client:GiveCoffee', function()
    ...
    Wait(5000)
    TriggerServerEvent('zlexif-vu:Server:GiveCoffee')
end)
