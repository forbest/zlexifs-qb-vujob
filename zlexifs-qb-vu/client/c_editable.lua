...
RegisterNetEvent('zlexif-vu:client:Eat', function(itemName)
    ...
    QBCore.Functions.Progressbar("eat_something", Language.Progressbars.Eating..QBCore.Shared.Items[itemName].label.."..", 6000, false, true, {
        ...
        TriggerServerEvent("zlexif-vu:Server:RemoveItem", itemName, 1)
...
RegisterNetEvent('zlexif-vu:client:Drink', function(itemName)
...
RegisterNetEvent('zlexif-vu:client:DrinkAlcahol', function(itemName)
